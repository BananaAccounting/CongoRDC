...
// @description = [DRC01] Layout 1 (BETA)
// @description.it = [DRC01] Layout 1 (BETA)
// @description.de = [DRC01] Layout 1 (BETA)
// @description.fr = [DRC01] Layout 1 (BETA)
// @description.nl = [DRC01] Layout 1 (BETA)
// @description.en = [DRC01] Layout 1 (BETA)
// @description.zh = [DRC01] Layout 1 (BETA)
// @description.pt = [DRC01] Layout 1 (BETA)
// @description.es = [DRC01] Layout 1 (BETA)
// @doctype = *
...
function convertParam(userParam) {
  ...
  *******************************************************************************************/
  ...
  currentParam = {};
  currentParam.name = 'info_rccm';
  currentParam.parentObject = 'info_include';
  currentParam.title = texts.param_info_rccm;
  currentParam.type = 'string';
  currentParam.value = userParam.info_rccm ? userParam.info_rccm : '';
  currentParam.defaultvalue = "";
  currentParam.tooltip = texts.param_info_rccm;
  currentParam.readValue = function() {
    userParam.info_rccm = this.value;
  }
  convertedParam.data.push(currentParam);

  currentParam = {};
  currentParam.name = 'info_id_nat';
  currentParam.parentObject = 'info_include';
  currentParam.title = texts.param_info_id_nat;
  currentParam.type = 'string';
  currentParam.value = userParam.info_id_nat ? userParam.info_id_nat : '';
  currentParam.defaultvalue = "";
  currentParam.tooltip = texts.param_info_id_nat;
  currentParam.readValue = function() {
    userParam.info_id_nat = this.value;
  }
  convertedParam.data.push(currentParam);
  ...
  currentParam.defaultvalue = texts.column_quantity+";"+texts.column_description+";"+texts.column_unit_price+";"+texts.column_amount;
  ...
  currentParam.defaultvalue = '10%;60%;15%;15%';
  ...
  ********************************************************************************************/
  ...
  for (var i = 0; i < langCodes.length; i++) {
    ...
    currentParam = {};
    currentParam.name = langCode+'_text_info_rccm';
    currentParam.parentObject = langCode;
    currentParam.title = langTexts[langCodeTitle+'_param_text_info_rccm'];
    currentParam.type = 'string';
    currentParam.value = userParam[langCode+'_text_info_rccm'] ? userParam[langCode+'_text_info_rccm'] : '';
    currentParam.defaultvalue = langTexts.rccm;
    currentParam.tooltip = langTexts['param_tooltip_text_info_rccm'];
    currentParam.language = langCode;
    currentParam.readValueLang = function(langCode) {
      userParam[langCode+'_text_info_rccm'] = this.value;
    }
    convertedParam.data.push(currentParam);

    currentParam = {};
    currentParam.name = langCode+'_text_info_id_nat';
    currentParam.parentObject = langCode;
    currentParam.title = langTexts[langCodeTitle+'_param_text_info_id_nat'];
    currentParam.type = 'string';
    currentParam.value = userParam[langCode+'_text_info_id_nat'] ? userParam[langCode+'_text_info_id_nat'] : '';
    currentParam.defaultvalue = langTexts.id_nat;
    currentParam.tooltip = langTexts['param_tooltip_text_info_id_nat'];
    currentParam.language = langCode;
    currentParam.readValueLang = function(langCode) {
      userParam[langCode+'_text_info_id_nat'] = this.value;
    }
    convertedParam.data.push(currentParam);
    ...
    currentParam.defaultvalue = texts.quantity+";"+langTexts.description+";"+texts.unit_price+";"+texts.amount;
...
function initParam() {
  ...
  */
  ...
  userParam.info_rccm = "";
  userParam.info_id_nat = "";
  userParam.details_columns = texts.column_quantity+";"+texts.column_description+";"+texts.column_unit_price+";"+texts.column_amount;
  userParam.details_columns_widths = '10%;60%;15%;15%';
  userParam.details_columns_alignment = 'center;center;center;center';
  ...
  for (var i = 0; i < langCodes.length; i++) {
    ...
    userParam[langCodes[i]+'_text_info_rccm'] = langTexts.rccm;
    userParam[langCodes[i]+'_text_info_id_nat'] = langTexts.id_nat;
    ...
    userParam[langCodes[i]+'_text_details_columns'] = langTexts.quantity+";"+langTexts.description+";"+langTexts.unit_price+";"+langTexts.amount;
...
function verifyParam(userParam) {
  ...
  */
  ...
  if (!userParam.info_rccm) {
    userParam.info_rccm = '';
  }
  if (!userParam.info_id_nat) {
    userParam.info_id_nat = '';
  }
  ...
  for (var i = 0; i < langCodes.length; i++) {
    ...
    if (!userParam[langCodes[i]+'_text_info_rccm']) {
      userParam[langCodes[i]+'_text_info_rccm'] = langTexts.rccm;
    }
    if (!userParam[langCodes[i]+'_text_info_id_nat']) {
      userParam[langCodes[i]+'_text_info_id_nat'] = langTexts.id_nat;
    }
  ...
  */
  ...
  if (userParam.logo_print) {
    ...
    if (logoFormat) {
     ...
     headerParagraph.addClass("header_left_text");
  }
...
function print_info(repDocObj, invoiceObj, texts, userParam, tableStyleRow0) {
  ...
  */
  ...
  if (userParam.info_customer) {
    tableRow = infoTable.addRow();
    tableRow.addCell(invoiceObj.supplier_info.business_name,"",1).setStyleAttributes("font-weight:bold");
  }

  // print custom info: numéro de régistre RCCM
  if (userParam.info_rccm) {
    tableRow = infoTable.addRow();
    // tableRow.addCell(userParam[lang+'_text_info_rccm'] + ":","",1).setStyleAttributes("font-weight:bold");
    tableRow.addCell(userParam.info_rccm,"",1).setStyleAttributes("font-weight:bold");
  }

  // Identité nationale
  if (userParam.info_id_nat) {
    tableRow = infoTable.addRow();
    // tableRow.addCell(userParam[lang+'_text_info_id_nat'] + ":","",1).setStyleAttributes("font-weight:bold");
    tableRow.addCell(userParam.info_id_nat,"",1).setStyleAttributes("font-weight:bold");
  }

  // Fiscal number = numéro impôt
  if (userParam.info_customer_fiscal_number) {
    tableRow = infoTable.addRow();
    tableRow.addCell(userParam[lang+'_text_info_customer_fiscal_number'] + ": " + invoiceObj.supplier_info.fiscal_number,"",1).setStyleAttributes("font-weight:bold");
  }

  // Address
  if (userParam.info_customer) {
    tableRow = infoTable.addRow();
    tableRow.addCell("Adresse: " + invoiceObj.supplier_info.address1,"",1).setStyleAttributes("font-weight:bold");    
  }

  // City
  if (userParam.info_customer) {
    tableRow = infoTable.addRow();
    tableRow.addCell(invoiceObj.supplier_info.city,"",1).setStyleAttributes("font-weight:bold");    
  }

  // Telephone
  if (userParam.info_customer) {
    tableRow = infoTable.addRow();
    tableRow.addCell(invoiceObj.supplier_info.phone,"",1).setStyleAttributes("font-weight:bold");    
  }

  // Email
  if (userParam.info_customer) {
    tableRow = infoTable.addRow();
    tableRow.addCell(invoiceObj.supplier_info.email,"",1).setStyleAttributes("font-weight:bold");    
  }
  ...
  if (userParam.info_date) {
    tableRow = infoTable.addRow();
    tableRow.addCell(userParam[lang+'_text_info_date'] + ": " + invoiceObj.document_info.date,"",1).setStyleAttributes("font-weight:bold");    
  }
  ...
  */
  ...
  for (var i = 0; i < invoiceObj.items.length; i++) {
    ...
    for (var j = 0; j < columnsSelected.length; j++) {
      ...
      if (columnsSelected[j] === "Quantity" || columnsSelected[j] === "quantity") {
      ...
      // }
        ...
        tableRow.addCell(Banana.Converter.toLocaleNumberFormat(item.unit_price.calculated_amount_vat_exclusive, variables.decimals_unit_price, true), "right"/*classNameEvenRow + " " + alignment + " padding-left padding-right " + className*/, 1).setStyleAttributes("border-right:thin solid black");
      }
      else if (columnsSelected[j] === "Amount" || columnsSelected[j] === "amount" || columnsSelected[j] === "total_amount_vat_exclusive") {
        tableRow.addCell(Banana.Converter.toLocaleNumberFormat(item.total_amount_vat_exclusive, variables.decimals_amounts, true), "right"/*classNameEvenRow + " " + alignment + " padding-left padding-right " + className*/, 1).setStyleAttributes("border-right:thin solid black");
      }
      else {
        var userColumnValue = "";
  ...
  tableRow = repTableObj.addRow();
  tableRow.addCell("", "thin-border-top", columnsNumber-1).setStyleAttributes("border-left:thin solid black;border-right:thin solid black");
  tableRow.addCell("", "thin-border-top", 1).setStyleAttributes("border-right:thin solid black");

  //TOTAL NET
  if (invoiceObj.billing_info.total_vat_rates.length > 0) {
    tableRow = repTableObj.addRow();
    tableRow.addCell(texts.totalnet, "padding-left padding-right", columnsNumber-1).setStyleAttributes("font-weight:bold;border-left:thin solid black");
    tableRow.addCell(Banana.Converter.toLocaleNumberFormat(invoiceObj.billing_info.total_amount_vat_exclusive, variables.decimals_amounts, true), "right padding-left padding-right", 1).setStyleAttributes("font-weight:bold;border-right:thin solid black");

    for (var i = 0; i < invoiceObj.billing_info.total_vat_rates.length; i++) {
      tableRow = repTableObj.addRow();
      tableRow.addCell(texts.vat + " " + invoiceObj.billing_info.total_vat_rates[i].vat_rate + "% (" + Banana.Converter.toLocaleNumberFormat(invoiceObj.billing_info.total_vat_rates[i].total_amount_vat_exclusive, variables.decimals_amounts, true) + ")", "padding-left padding-right", columnsNumber-1).setStyleAttributes("font-weight:bold;border-left:thin solid black");
      tableRow.addCell(Banana.Converter.toLocaleNumberFormat(invoiceObj.billing_info.total_vat_rates[i].total_vat_amount, variables.decimals_amounts, true), "right padding-left padding-right", 1).setStyleAttributes("font-weight:bold;border-right:thin solid black;border-right:thin solid black");
    }
  }
...
function getInvoiceSupplier(invoiceSupplier) {
  ...
  //   supplierAddress = supplierAddress + invoiceSupplier.fiscal_number;
  // }
...
function set_variables(variables, userParam) {
  ...
  */
  ...
  variables.$margin_top_info = "10mm";
...
function setInvoiceTexts(language) {
  ...
  */
  ...
  if (language === 'it') {
    ...
    texts.column_unit_price = "UnitPrice";
    texts.column_amount = "Amount";
    texts.description = "DÉSIGNATION";
    texts.quantity = "Qté";
    texts.reference_unit = "Unité";
    texts.unit_price = "P.U.";
    texts.amount = "P.T.";
    texts.totalnet = "TOTAL BRUT";
    texts.vat = "TVA";
    texts.rounding = "Arrondi";
    texts.total = "NET À PAYER TTC";
    ...
    texts.param_info_rccm = "RCCM";
    texts.param_info_id_nat = "ID. NAT.";
    ...
    texts.fr_param_text_info_rccm = "RCCM";
    texts.fr_param_text_info_id_nat = "ID. NAT.";
    ...
    texts.param_tooltip_info_rccm = "Insérez un texte pour remplacer le texte par défaut";
    texts.param_tooltip_info_id_nat = "Insérez un texte pour remplacer le texte par défaut";
    ...
    texts.param_tooltip_text_info_rccm = "Insérez un texte pour remplacer le texte par défaut";
    texts.param_tooltip_text_info_id_nat = "Insérez un texte pour remplacer le texte par défaut";
